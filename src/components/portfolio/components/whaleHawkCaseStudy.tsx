...
const architectureDecisions = [
  "Designed entity resolution as the data backbone, enabling a single dossier to serve 400+ clients",
  "Architected microservice separation strategy across Source Pipeline, Intelligence Layer, and Provider Prep Server",
    ...
    >
      ...
      <motion.div variants={item} className="mb-8">
        <p className="text-base text-gray-700 leading-relaxed max-w-4xl">
          ...
          the Intelligence Layer, the data layer in Provider Prep Server, and the consumer-facing APIs
