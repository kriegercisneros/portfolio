...
// const SystemArchitecture: FC<MyResponsiveNetworkCanvasProps> = ({ data }) => (
...
const SystemArchitecture: FC<NetworkProps> = ({ data }) => (
    <div className="h-[600px] w-full">
        <ResponsiveNetworkCanvas
            data={data}
            margin={{ top: 20, right: 20, bottom: 20, left: 20 }}
            linkDistance={function(e: any) {
            ...
            linkThickness={2}
            inactiveNodeSize={function(n: any) { return n.size }}
            activeNodeSize={function(n: any) { return n.size * 1.2 }}
